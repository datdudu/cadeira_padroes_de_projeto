...
/**
 * Código ANTES da refatoração - classe cheia de responsabilidades extras Problema: Múltiplas
 * funcionalidades opcionais em uma única classe, tornando-a complexa e difícil de manter
 */
