...
/**
 * Context - Classe que utiliza as estratégias de desconto
 * Resultado da refatoração "Replace Conditional with Polymorphism"
 * Elimina os condicionais if/else através do uso do padrão Strategy
 */
